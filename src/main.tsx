...
if (
  ...
  import("eruda").then((eruda) => {
    eruda.default.init();
    console.log(
      "🔍 Eruda mobile debugger initialized for production debugging"
    );
  });
}
...
if (typeof window !== "undefined") {
  (
    window as typeof window & {
      diagnosticPaymentService: typeof diagnosticPaymentService;
    }
  ).diagnosticPaymentService = diagnosticPaymentService;
  console.log(
