...
const resources = {
  ...
  th: {
    translation: {
      ...
      digitalDelivery: "การจัดส่งแบบดิจิทัล",
  ...
  ms: {
    translation: {
      ...
      digitalDelivery: "Penghantaran digital",
  ...
  ph: {
    translation: {
      ...
      phone: "Telepono",
      email: "Email",
      invalidEmail: "Pakipasukin ang wastong email address",
      selectCity: "Piliin ang Lungsod",
      shippingMethod: "Paraan ng paghahatid",
      deliveryMethod: "Paraan ng paghahatid",
      digitalDelivery: "Digital na paghahatid",
  ...
  id: {
    translation: {
      ...
      digitalDelivery: "Pengiriman digital",
